...
task_configs = {
    ...
    # Custom ADME task (user-provided CSV: smiles/logPapp)
    'caco2': (['logPapp'], 'regression', 'mse'),
    'iv_hcl': (['CL'], 'regression', 'mse'),
    'iv_hvdss': (['VDss'], 'regression', 'mse'),
    'rliver_mstability_binary': (['Label'], 'classification', 'bce')
}
